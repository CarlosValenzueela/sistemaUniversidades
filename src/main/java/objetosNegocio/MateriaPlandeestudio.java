 ...
 */
@Entity
@Table(name = "rel_materiasplanesdeestudio")
public class MateriaPlandeestudio implements Serializable {

    
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "idrel_materiasplanesdeestudio")
    private Integer id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MateriaPlandeestudio)) {
            return false;
        }
        MateriaPlandeestudio other = (MateriaPlandeestudio) object;
